...
<body class="">
  <div class="wrapper">
        ...
        <ul class="nav">
          <li>
            <a>
              ...
              <p id="new-db">Nouvelle base de données</p>
            </a>
          </li>
          <li>
            <ul>
              <ul>
                ...
                while ($row = $dbs->fetch()) {
                  ...
                  <div class="row " >
                    <div class="col-4">
                      <p style="cursor: pointer" class="db" id="' . $row[0] . '"> ' . $row[1] . '</p>
                    </div>
                    <div class="col-4">
                      <div class="dropdown">
    ...
    <div class="main-panel">
      ...
      <div id="content-card" class="content">
        <?php
        if (!isset($_GET['dbId'])) {
...
');
...
</svg></i><i class="delete-db" id="' . $row[0] . '"><svg style="cursor: pointer" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash2-fill" viewBox="0 0 16 16">
  ...
  <script src="../assets/js/dbManagement.js"></script>
</body>
