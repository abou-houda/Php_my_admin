...
?>
        <script>
            window.location = './index.php?page=table_data_list&&section=parcourir&&db=<?php echo $_GET['db']; ?>&&table=<?php echo $_GET['table']; ?>&&successmsg=1 ligne insérée.';
        </script>
    <?php
    } else {
    ?>
        <script>
            window.location = './index.php?page=table_data_list&&section=parcourir&&db=<?php echo $_GET['db']; ?>&&table=<?php echo $_GET['table']; ?>&&errormsg=erreur a lhors de insertion svp ressayer dans qq seconds';
        </script>
<?php
    }
}
